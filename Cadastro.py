...
if dias_adiantados_simulado > 7:
    juros_simulado = (9.8/30)*dias_adiantados_simulado

juros_final = juros_simulado*valor_nota_simulado
m1.metric(label="Juros", value=f"{juros_simulado:,.2f}%".replace(".", ","))
